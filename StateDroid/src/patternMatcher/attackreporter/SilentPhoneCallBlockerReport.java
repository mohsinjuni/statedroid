...
public class SilentPhoneCallBlockerReport extends Report {
	...
	public SilentPhoneCallBlockerReport() {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof SilentPhoneCallBlockerReport))
			return false;
		SilentPhoneCallBlockerReport other = (SilentPhoneCallBlockerReport) obj;
