...
public class PhoneCallForwardingReport extends Report {

	private String callForwardingCode = "";
	...
	public PhoneCallForwardingReport() {
	...
	public int hashCode() {
		...
		result = prime * result + ((callForwardingCode == null) ? 0 : callForwardingCode.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof PhoneCallForwardingReport))
			return false;
		PhoneCallForwardingReport other = (PhoneCallForwardingReport) obj;
		...
		//			return false;
		if (callForwardingCode == null) {
			if (other.callForwardingCode != null)
				return false;
		} else if (!callForwardingCode.equals(other.callForwardingCode))
			return false;
		if (sinkAPI == null) {
	...
	public void printReport() {
		logger.fatal("\n\n[msg] = " + this.getMessage());
		logger.fatal("\n[callForwardingCode] = " + this.getCallForwardingCode());
	...
	public String getPhoneNo() {
		return callForwardingCode;
	}

	public void setPhoneNo(String phoneNo) {
		this.callForwardingCode = phoneNo;
	}
	...
	public String getCallForwardingCode() {
		return callForwardingCode;
	}

	public void setCallForwardingCode(String callForwardingCode) {
		this.callForwardingCode = callForwardingCode;
	}
