...
public class PhoneCallBlockerReport extends Report {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof PhoneCallBlockerReport))
			return false;
		PhoneCallBlockerReport other = (PhoneCallBlockerReport) obj;
