...
public class AnswerRingingCallMethodDeclaredState extends ReflectionStates{

	private TaintAnalyzer ta;
	private static Logger logger;
	private SymbolSpace localSymSpace = Config.getInstance().getLocalSymbolSpace();
	public AnswerRingingCallMethodDeclaredState(TaintAnalyzer taParam)
	{
		this.ta = taParam;
...
//		0x10a move-result-object v9 
	...
	public State update(MethodInvokeEvent e) {
		...
		if(callerEntry != null){
			...
			if(state != null && state instanceof AnswerRingingCallMethodDeclaredState){
