...
public class PhoneCallBlockerState extends LockScreenSilentPhoneCallBlockerASMStates{
	...
	public State update(RingerModeNormalASMEvent e) {
		...
		String permStr = Config.getInstance().getCurrCFGPermutationString();
 		...
 		rep.setMessage(" [ATK] ##### This app checks if device is locked or not, reduce phone volume, block incoming call and then restore the volume.::");
