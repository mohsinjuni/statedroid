package patternMatcher.statemachines.asm.lockscreensilentphonecallblockerASM;
...
import patternMatcher.statemachines.asm.lockscreensilentphonecallblockerASM.states.InitialState;
import taintanalyzer.TaintAnalyzer;


public class LockScreenSilentPhoneCallBlockerASMObserver extends AttackObserver {
	...
	*/	
	...
	public LockScreenSilentPhoneCallBlockerASMObserver (TaintAnalyzer taParam){
		this.taSubject = taParam;
		this.state = new InitialState(this.taSubject);
	}
	
	public LockScreenSilentPhoneCallBlockerASMObserver (){
