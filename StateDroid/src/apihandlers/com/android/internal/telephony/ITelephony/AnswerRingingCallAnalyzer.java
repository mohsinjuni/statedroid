...
public class AnswerRingingCallAnalyzer extends BaseTaintAnalyzer{
	...
	public AnswerRingingCallAnalyzer(TaintAnalyzer ta)
	{
		ir = ta.getIr();
		instr = ta.getIr().getInstr();
		this.ta = ta;
		this.localSymSpace = Config.getInstance().getLocalSymbolSpace();	
		logger = Logger.getLogger(AnswerRingingCallAnalyzer.class);
	}
 ...
 */
	...
	public Object analyzeInstruction()
	{
		...
		if(callerApiEntry != null)
		{
			...
			EventFactory.getInstance().registerEvent("iTelephonyAnswerRingingCallEvent", new ITelephonyAnswerRingingCallEvent());
			
			Event event = EventFactory.getInstance().createEvent("iTelephonyAnswerRingingCallEvent");
			
			event.setName("iTelephonyAnswerRingingCallEvent");
