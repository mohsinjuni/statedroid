...
public class ResetPasswordWithTokenAnalyzer extends BaseTaintAnalyzer{
	...
	0x0 const-string v3, 'device_policy'
		...
		0x32 const/4 v4, 1
		0x34 invoke-virtual v1, v3, v4, Landroid/app/admin/DevicePolicyManager;->resetPasswordWithToken(Ljava/lang/String; I)Z
		0x3a move-result v2
		boolean resetPasswordWithToken (String password, int flags) //This is available only in O preview yet.
	 */

	public ResetPasswordWithTokenAnalyzer(TaintAnalyzer ta){
		ir = ta.getIr();
		instr = ta.getIr().getInstr();
		this.localSymSpace = Config.getInstance().getLocalSymbolSpace();		
		logger = Logger.getLogger(ResetPasswordWithTokenAnalyzer.class);
		this.ta = ta;
	}
