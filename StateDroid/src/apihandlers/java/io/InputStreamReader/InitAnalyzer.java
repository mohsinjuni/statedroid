package apihandlers.java.io.InputStreamReader;
		...
		if(regCount == 2)
		{
	        ...
	        if(callerEntry != null)
	        {
	        	...
	        	if(inputParamEntry != null)
	        	{
	        		...
	        		recordFieldList.put("inputStreamEntry", inputParamEntry);
	        		callerEntry.getEntryDetails().setRecordFieldList(recordFieldList);
	        		callerEntry.getEntryDetails().setRecord(true);
	        		
					EventFactory.getInstance().registerEvent("inputStreamReaderDefinedEvent", new InputStreamReaderDefinedEvent());
					Event event = EventFactory.getInstance().createEvent("inputStreamReaderDefinedEvent");
					event.setName("inputStreamReaderDefinedEvent");
