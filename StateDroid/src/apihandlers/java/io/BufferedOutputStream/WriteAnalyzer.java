package apihandlers.java.io.BufferedOutputStream;
...
//		0x28a invoke-virtual v0, v8, v1, v2, Ljava/io/BufferedOutputStream;->write([B I I)V
	...
	public Object analyzeInstruction(){
        ...
        if(callerEntry != null){
	    	...
	    	if(inputParamEntry != null){
	    		...
	    		EventFactory.getInstance().registerEvent("bufferedOutputStreamWriteEvent", new BufferedOutputStreamWriteEvent());
				Event event = EventFactory.getInstance().createEvent("bufferedOutputStreamWriteEvent");
				event.setName("bufferedOutputStreamWriteEvent");
